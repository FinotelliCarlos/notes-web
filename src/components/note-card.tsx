...
export function NoteCard({ note }: NoteCardProps) {
  return (
    <Dialog.Root>
      <Dialog.DialogTrigger className="rounded-md bg-slate-800 p-5 gap-3 flex flex-col overflow-hidden relative hover:ring-2 outline-none hover:ring-slate-600 text-left focus-visible:ring-2 focus-visible:ring-lime-400">
